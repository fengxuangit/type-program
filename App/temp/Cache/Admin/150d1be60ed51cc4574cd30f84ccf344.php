...
<body>
	...
	<div id="left">
		<dl>
			<dt>帖子管理</dt>
			<dd><a href="<?php echo U('Admin/Manage/index');?>">查看帖子</a></dd>
			<dd><a href="<?php echo U('Admin/Manage/add');?>">添加帖子</a></dd>
			<dd><a href="<?php echo U('Admin/Manage/grades');?>">查看排名</a></dd>
		</dl>
		<dl>
			<dt>用户管理</dt>
			...
			<dd><a href="<?php echo U('Admin/Rbac/addRole');?>">添加节点</a></dd>
			<dd><a href="<?php echo U('Admin/Rbac/addNole');?>">添加角色</a></dd>
